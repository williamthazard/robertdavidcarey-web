...
class WebmentionTestCase(TestCase):
    ...
    def test_webmention_model_str(self):
        wm = Webmention.objects.create(
            target_url="https://robertdavidcarey.com/log/240809-test-post/",
    ...
    def test_webhook_creates_webmention_and_matches_log_entry(self):
        payload = {
            ...
            "target": "https://robertdavidcarey.com/log/240809-test-post/",
            "post": {
                "type": "entry",
                "name": "Nice post!",
    ...
    def test_log_detail_view_renders_approved_webmentions(self):
        Webmention.objects.create(
            ...
            target_url=f"https://robertdavidcarey.com/log/{self.log_entry.slug}/",
        ...
        self.assertContains(response, "Awesome post!")
            ...
            "children": [
                {
                    ...
                    "wm-target": "https://robertdavidcarey.com/log/240809-test-post/",
                    "wm-property": "in-reply-to",
                    "content": {
                        "text": "Synced via API!"
                    }
